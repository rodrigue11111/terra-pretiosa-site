    ...
    <section className="bg-neutral-100 py-16">
      <div className="tp-container grid gap-8 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="space-y-6">
          ...
          <article className="rounded-sm border border-neutral-200 bg-white p-5">
          ...
          <article className="rounded-sm border border-neutral-200 bg-white p-5 text-sm text-slate-700">
            <p>
